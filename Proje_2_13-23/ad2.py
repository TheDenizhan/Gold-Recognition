...
# Plot the Predictions for Extended Future Dates
fig, ax = plt.subplots(figsize=(12, 6))
ax.plot(df['Date'], df['Price'], color='black', lw=2, label='Historical Data')
ax.plot(future_dates_extended, future_predictions_extended, color='green', lw=2, label='Predicted Future Data (Extended)')
